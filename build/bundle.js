...
var _NavbarComponent = __webpack_require__(33);

var _NavbarComponent2 = _interopRequireDefault(_NavbarComponent);

var _HeaderComponent = __webpack_require__(53);

var _HeaderComponent2 = _interopRequireDefault(_HeaderComponent);

var _PokemonChartComponent = __webpack_require__(54);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    key: 'deletePokemon',
    value: function deletePokemon(e, index) {
      console.log('Pokemon Selected for Deletion: ', e.target);

      var copyOfFavoriteArrays = this.state.favorites.slice();
      var name = copyOfFavoriteArrays[index].nameOfPokemon;
      ...
      _axios2.default.post('/delete', { nameOfPokemon: name }).then(function (res) {
...
*/
var aa=__webpack_require__(5),ba=__webpack_require__(1),m=__webpack_require__(11),p=__webpack_require__(4),v=__webpack_require__(3),da=__webpack_require__(12),ea=__webpack_require__(13),fa=__webpack_require__(14),ha=__webpack_require__(6);
...
var _NavbarItemsComponent = __webpack_require__(34);

var _NavbarItemsComponent2 = _interopRequireDefault(_NavbarItemsComponent);
...
var NavbarItemsComponent = function (_React$Component) {
  _inherits(NavbarItemsComponent, _React$Component);

  function NavbarItemsComponent(props) {
    _classCallCheck(this, NavbarItemsComponent);

    return _possibleConstructorReturn(this, (NavbarItemsComponent.__proto__ || Object.getPrototypeOf(NavbarItemsComponent)).call(this, props));
  }
  ...
  return NavbarItemsComponent;
}(_react2.default.Component);

exports.default = NavbarItemsComponent;
...
var HeaderComponent = function HeaderComponent() {
  ...
  return _react2.default.createElement(
    'header',
    { className: 'pokemon-header-section-container' },
    _react2.default.createElement(
      'div',
...
var PokemonChartComponent = function (_React$Component) {
  _inherits(PokemonChartComponent, _React$Component);

  function PokemonChartComponent(props) {
    _classCallCheck(this, PokemonChartComponent);
  ...
  _createClass(PokemonChartComponent, [{
    ...
    value: function makeAxiosCall(userInput) {
      ...
      _axios2.default.post('/', { userInput: userInput }).then(function (response) {
  ...
  return PokemonChartComponent;
}(_react2.default.Component);

exports.default = PokemonChartComponent;
...
var UserInputComponent = function (_React$Component) {
  _inherits(UserInputComponent, _React$Component);

  function UserInputComponent(props) {
    _classCallCheck(this, UserInputComponent);
  ...
  _createClass(UserInputComponent, [{
    key: 'handleUserInput',
    value: function handleUserInput(input) {
      ...
      this.setState({
        ...
        return console.log('User input: ', _this2.state.userInput);
      });
    }
  }, {
      ...
      return _react2.default.createElement(
        ...
        { action: '',
          onKeyDown: function onKeyDown(e) {
            return _this3.handleUserSubmit(e, _this3.state.userInput);
          } },
        _react2.default.createElement('input', {
          onChange: function onChange(e) {
            return _this3.handleUserInput(e.target.value);
          },
...
exports.default = UserInputComponent;
...
var PokemonBoxComponent = function (_React$Component) {
  _inherits(PokemonBoxComponent, _React$Component);
...
exports.default = PokemonBoxComponent;
...
var FavoritePokemon = function FavoritePokemon(_ref) {
  var favoritePokemonArr = _ref.favoritePokemonArr,
      ...
      deletePokemon = _ref.deletePokemon;
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        favoritePokemonArr.map(function (pokemon, i) {
          return _react2.default.createElement(
            'li',
            { key: i, className: 'fav-pokemon-li', onClick: function onClick(e) {
                return deletePokemon(e, i);
              } },
            _react2.default.createElement(
              'p',
              null,
